...
Now, we want to build a linear model for each country. But we don't want to copy paste those 20 lines for each country (since there are `r gapminder |> distinct(country) |> nrow()` countries).
...
gapminder_model('China')
gapminder_model('Cambodia')
gapminder_model('Canada')
gapminder_model('Brazil')
gapminder_model('Iraq')
```
...
<!-- ``` -->
<!-- <iframe src="https://giphy.com/embed/Pr1kbbDes569lEjqLz" width="480" height="480" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/gifs/Pr1kbbDes569lEjqLz">via GIPHY</a></p> -->
<!-- ``` -->
