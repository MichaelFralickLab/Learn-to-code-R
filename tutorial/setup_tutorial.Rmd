...
This is a setup tutorial. Try to install R, Rstudio, and tidverse but **don't worry if you run into issues** - just email me ja.moggridge@gmail.com if you need any help!
...
quiz(caption = "Quiz - Install RStudio",
  question("What is the RStudio IDE?",
    answer("An application that makes it easier to use R.", correct = TRUE, message = "RStudio organizes your workspace and makes it easier to write, use, debug, and save R code. I highly recommend it and will rely on the RStudio IDE in the seminars."),
    ...
    answer("A spreadsheet program like Microsoft Excel.", message = "In some ways! But having code provides a reproducible record of your work, which is essential for data science."),
...
You're now ready to start programming in R. I look forward to coding with you soon!
